...
//    参考: https://pjreddie.com/darknet/train-cifar/
    ...
    *****************************************************************/
    ...
    char* parameters[] = {"./darknet",
                          ...
                          "../cfg/voc.data",
                          "../cfg/yolov2-voc.cfg",
                          "../pre-train-weighted/darknet19_448.conv.23"};
    argv = parameters;
    *****************************************************************/
    ...
    gpu_index = find_int_arg(argc, argv, "-i", 0);  // 获取输入配置中给出的gpu编号, 默认为0

    if(find_arg(argc, argv, "-nogpu")) {
        gpu_index = -1;
        printf("\n Currently Darknet doesn't support -nogpu flag. "
               "If you want to use CPU - please compile Darknet with GPU=0 "
               "in the Makefile, or compile darknet_no_gpu.sln on Windows.\n");
        exit(-1);
    }
    ...
    if (0 == strcmp(argv[1], "average")){
        ...
        // 训练分类网络, run_classifier()函数更多的是作为一个train, test, val的一个接口函数
