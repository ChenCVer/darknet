...
{   // TODO: 很奇怪,这里怎么会是获取短接的层的输入特征图的大小??
    ...
    if (l.nweights == 0 && l.n == 1 && from_w == l.w && from_h == l.h && from_c == l.c) {
        ...
        shortcut_multilayer_cpu(l.outputs * l.batch, l.outputs, l.batch, l.n, l.input_sizes, l.layers_output,
                                l.output, state.input, l.weights, l.nweights, l.weights_normalization);
    }
